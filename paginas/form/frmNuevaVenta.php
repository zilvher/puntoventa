...
<div class="login-container" style="height:auto; margin-top:32px;">
  ...
  <div class="group-flex">
    <form action="../control/srchcliVentas.php" method="post">
      <input type="number" name="cliCI" class="control-form" placeholder="Número de CI">
      <button type="submit" class="btn control-form">Buscar</button>
    </form>
  </div>
